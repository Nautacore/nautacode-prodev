...
export default function Navbar() {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-gray-900/80 backdrop-blur-md border-b border-gray-700 shadow-xl">
      {/* AQUÍ ESTÁ EL TRUCO: 
        1. Quitamos el "p-4" del nav.
        2. Ponemos "h-16" al div para que siempre mida 64px de alto.
        3. "items-center" centra el logo y los links verticalmente.
      */}
      <div className="container mx-auto h-16 px-4 flex justify-between items-center">
        ...
        <div className="flex gap-6 text-sm font-medium">
          <Link href="/frontend" className="text-gray-300 hover:text-white transition-colors">Frontend</Link>
